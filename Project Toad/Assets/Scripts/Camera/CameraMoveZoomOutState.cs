...
public class CameraMoveZoomOutState : CameraMoveState
{
    ...
    public override CameraMoveState onUpdate()
    {
        ...
        if ((playerViewportDiff < _zoomOutThreshold) && (_camController.CurrZoomLevel < _camController.MaxZoomLevel))
        {
            _camController.CurrZoomLevel += _camController.ZoomSpeed;
            _camController.CurrZoomLevel = Mathf.Min(_camController.CurrZoomLevel, _camController.MaxZoomLevel);
        }
